...
if ! wp core is-installed --allow-root; then
    ...
    wp core install --url=jecolmou.42.fr --title="Inception" --admin_user=$WORDPRESS_DB_USER --admin_password=$WORDPRESS_USER_PASSWORD --admin_email=$WORDPRESS_ROOT_MAIL --skip-email --allow-root
